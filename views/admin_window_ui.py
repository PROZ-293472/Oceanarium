...
class Ui_AdminWindow(object):
    def setupUi(self, AdminWindow):
        ...
        self.pushButton_add.setGeometry(QtCore.QRect(610, 10, 61, 31))
        self.pushButton_add.setObjectName("pushButton_add")
        self.pushButton_delete = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_delete.setGeometry(QtCore.QRect(680, 10, 71, 31))
        self.pushButton_delete.setObjectName("pushButton_delete")
        self.pushButton_edit = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_edit.setGeometry(QtCore.QRect(760, 10, 71, 31))
        ...
        self.comboBox_sortBy.setGeometry(QtCore.QRect(280, 70, 301, 22))
        ...
        self.label_sort2.setGeometry(QtCore.QRect(610, 50, 81, 16))
        self.label_sort2.setObjectName("label_sort2")
        self.comboBox_sortSettings = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_sortSettings.setGeometry(QtCore.QRect(610, 70, 361, 22))
        ...
        self.tableView.setHorizontalHeader(QtWidgets.QHeaderView(QtCore.Qt.Horizontal))
        self.tableView.horizontalHeader().setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
