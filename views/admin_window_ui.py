...
class Ui_AdminWindow(object):
    def setupUi(self, AdminWindow):
        ...
        self.lineEdit_searchQuery.setGeometry(QtCore.QRect(550, 70, 241, 21))
        self.lineEdit_searchQuery.setObjectName("lineEdit_searchQuery")
        self.comboBox_sortBy = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_sortBy.setGeometry(QtCore.QRect(30, 70, 261, 22))
        ...
        self.label_sort2.setGeometry(QtCore.QRect(310, 50, 221, 16))
        self.label_sort2.setObjectName("label_sort2")
        self.comboBox_searchColumn = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_searchColumn.setGeometry(QtCore.QRect(310, 70, 221, 22))
        ...
        self.label_sort2_2.setGeometry(QtCore.QRect(550, 50, 241, 16))
        self.label_sort2_2.setObjectName("label_sort2_2")
        self.pushButton_search = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_search.setGeometry(QtCore.QRect(810, 70, 161, 21))
    ...
    def retranslateUi(self, AdminWindow):
        ...
        self.label_sort2_2.setText(_translate("AdminWindow", "Search phrase:"))
        self.pushButton_search.setText(_translate("AdminWindow", "SEARCH"))
